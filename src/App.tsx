    ...
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="ban-hang" element={
          <ProtectedRoute allowedRoles={["ADMIN", "SALE"]} requiredPermissions={["MANAGE_SALES"]}>
            <BanHang />
          </ProtectedRoute>
        } />
        ...
        <Route path="so-quy" element={
          <ProtectedRoute allowedRoles={["ADMIN"]} requiredPermissions={["MANAGE_CASHBOOK"]}>
            <SoQuy />
          </ProtectedRoute>
        } />
        ...
        <Route path="bao-cao-ton-kho" element={
          <ProtectedRoute allowedRoles={["ADMIN", "KHO_MAY", "TRUONG_KT", "SALE"]} requiredPermissions={["VIEW_REPORTS"]}>
            <InventoryMatrix />
          </ProtectedRoute>
        } />
        ...
        <Route path="nha-cung-cap" element={
          <ProtectedRoute allowedRoles={["ADMIN", "KHO_MAY"]} requiredPermissions={["MANAGE_SUPPLIERS"]}>
            <NhaCungCap />
          </ProtectedRoute>
        } />
